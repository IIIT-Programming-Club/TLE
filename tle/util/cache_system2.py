...
CONTEST_BLACKLIST = [1308, 1309, 1431, 1432, 1522, 1524, 1531, 1535, 1595]
        ...
        for contest in contests_by_phase["BEFORE"]:
            ...
            if at > now:
                ...
                delay = min(
                    ...
                    self._ACTIVE_CONTEST_RELOAD_DELAY,
                )
...
class RanklistCache:
    ...
    async def generate_ranklist(
        self, contest_id, *, fetch_changes=False, predict_changes=False
    ):
